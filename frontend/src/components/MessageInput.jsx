...
function MessageInput() {
  ...
  return (
    <div className="border-t border-slate-700/50 bg-slate-900/20 relative">
      ...
      <div className="p-4">
        {/* Voice recorder replaces the whole input bar while recording */}
        {isRecording ? (
        ...
        {imagePreview && (
          <div className="max-w-3xl mx-auto mb-3 flex items-center">
            ...
            <form onSubmit={handleSendMessage} className="max-w-3xl mx-auto flex items-center space-x-2 md:space-x-3">
              ...
              {/* Send OR Mic button — mic shows when nothing typed/attached */}
              {text.trim() || imagePreview ? (
                ...
                <button
                  ...
                  className="bg-slate-800/50 text-slate-400 hover:text-cyan-400 hover:bg-slate-800 rounded-lg p-2.5 transition-colors"
